...
st.write(
    "Beginner-friendly Japanese assistant for JLPT N5 translation, "
    "vocabulary support, and simple chat practice."
)
...
if st.button("Send"):
    if not user_text.strip():
        ...
        try:
            ...
            st.error("Backend request timed out. The model may still be loading.")